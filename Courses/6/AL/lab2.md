...
:::Figure (skater|l|R)
![](imgs/Lab3/skaterboi.jpg "UCSB's preferred mode of transit")
:::
...
::::::row
:::col
![](imgs/Lab3/Figure_1.2_final.jpg "(a) The overall schematic of the air track experiment")
:::
:::col
![](imgs/Lab3/rail.png "(b) A cartoon demonstrating how air blows through the track")
:::
::::::
:::::::::
...
where $b$ is the height of the block used to place the track on an incline, and $D$ is the distance between the track's legs in [Fi](#Fi-hov3). 
